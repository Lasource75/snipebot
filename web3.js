 ...
 * DEX ABI
 */
const TRADER_JOE_ROUTER_CONTRACT = new web3.eth.Contract(ABI_TRADER_JOE_ROUTER, TRADER_JOE_ROUTER_ADDRESS, { from: account.address });

const TRADER_JOE_FACTORY_CONTRACT = new web3.eth.Contract(ABI_TRADER_JOE_FACTORY, TRADER_JOE_FACTORY_ADDRESS, { from: account.address });

const PANGOLIN_ROUTER_CONTRACT = new web3.eth.Contract(ABI_PANGOLIN_ROUTER, PANGOLIN_ROUTER_ADDRESS, { from: account.address });
const PANGOLIN_FACTORY_CONTRACT = new web3.eth.Contract(ABI_PANGOLIN_FACTORY, PANGOLIN_FACTORY_ADDRESS, { from: account.address });

export default {
    web3,
    MIM, AVAX, USDC,
    axios, fs,
    TRADER_JOE_ROUTER_ADDRESS, TRADER_JOE_FACTORY_ADDRESS, PANGOLIN_ROUTER_ADDRESS, PANGOLIN_FACTORY_ADDRESS,
    ABI_TRADER_JOE_ROUTER, ABI_TRADER_JOE_FACTORY, ABI_PANGOLIN_ROUTER, ABI_PANGOLIN_FACTORY, ABI_APPROVE,
    TRADER_JOE_ROUTER_CONTRACT, TRADER_JOE_FACTORY_CONTRACT, PANGOLIN_ROUTER_CONTRACT, PANGOLIN_FACTORY_CONTRACT,
    account
}
